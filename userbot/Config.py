...
if ENV:
    ...
    class Config(object):
        ...
        SCREEN_SHOT_LAYER_ACCESS_KEY = os.environ.get("SCREEN_SHOT_LAYER_ACCESS_KEY", False)
        ...
        FBAN_LOGGER_GROUP = os.environ.get("FBAN_LOGGER_GROUP", -1001462549597)
        ...
        SUDO_IDS = set(int(x) for x in os.environ.get("SUDO_IDS", "").split())
